...
**Overview**
This project is a lexical analyzer (scanner) for a custom Mini C++-like language, implemented in Flex. The scanner tokenizes source code, identifies keywords, identifiers, numbers, operators, and punctuations, and also handles errors.
